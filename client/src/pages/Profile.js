...
const Profile = () => {
  ...
  <div class="flex flex-col h-screen justify-start">
    ...
    <h1 className='font-bold mb-1 text-2xl md:text-lg lg:text-xl px-4 pt-4 md:pt-0 w-screen md:text-right md:pr-9 lg:pb-5'>Dashboard</h1>
    
    {/* body start */}
    <main class="sm:grid sm:grid-cols-3 mx-4 text-base">
    {/*md break column 1 */}
    <div className="pt-1 w-sm">
      ...
      <div className=''>
      <h2 className='font-semibold text-xl'>Message Center</h2>
      <h3 className='font-normal mb-1 text-lg'>Tap message to expand chat model</h3>
        <div className='flex flex-col justify-center text-xl tracking-wide font-semibold'>
    ...
    {/*md break column 2 */}
    <div className="w-full sm:p-2 pt-4 sm:pt-1 rounded-lg w-sm text-lg">
